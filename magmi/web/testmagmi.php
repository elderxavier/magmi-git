...
require_once ("/magmi/web/header.php");
require_once ("/magmi/web/magmi_config.php");
require_once ("/magmi/web/magmi_statemanager.php");
...
$postinst = "/web/inc/magmi_postinstall.php";
...
foreach (array("/web/state","/web/conf","/web/plugins") as $dirname)
{
...
if (count($badrights) == 0)
{
    ...
    else
    {
        ...
        require_once ("/magmi/web/magmi_config_setup.php");
        require_once ("/magmi/web/magmi_profile_config.php");
    }
}
else
{
...
?>
<?php require_once("/magmi/web/footer.php");?>
